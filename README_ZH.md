...
1. **启动 Codespace**
   ...
   - 点击 `Create codespace on notebook` 启动环境
...
### 方式二：Google Colab（无需本地环境）

只需点击下方链接，即可在 Google Colab 中在线运行教程：
...
- **01_Getting_Started** - Data Juicer 核心概念与快速入门
- **02_Building_Recipes** - 数据处理配方的设计与构建
- **03_Data_Formats_and_Loading** - 数据格式支持与加载方法详解
- **04_DJ_Dataset_API** - Dataset API 完整指南
- **05_Operators_Usage** - 数据处理算子详解（YAML与Python两种模式）
- **06_Analysis_and_Visualization** - 数据分析与可视化工具
- **07_Distributed_Processing_with_Ray** - Ray 分布式处理框架集成
- **08_Preprocessing** - 数据预处理脚本与最佳实践
- **09_Multimodal_Data_Processing** - 多模态数据处理能力
- **10_Advanced_Dataset_Configuration** - Dataset 高级配置选项
